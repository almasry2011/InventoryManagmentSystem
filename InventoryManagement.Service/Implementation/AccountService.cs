    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task<Response<AuthenticationResponse>> AuthenticateAsync(AuthenticationRequest request, string ipAddress)
        {
            ...
            try
            {
                ...
                if (user == null)
                {
                    res.Errors.Add($"No Accounts Registered with {request.UserName}.");
                    res.Message=($"No Accounts Registered with {request.UserName}.");
                ...
                if (!result.Succeeded)
                {
                    res.Errors.Add($"Invalid Credentials for '{request.UserName}'.");
                    res.Message=($"Invalid Credentials for '{request.UserName}'.");

                    throw new Exception();
                }
                if (!user.EmailConfirmed)
                {
                    res.Errors.Add($"Account Not Confirmed for '{request.UserName}'.");
                    res.Message=($"Account Not Confirmed for '{request.UserName}'.");
                    throw new Exception();
