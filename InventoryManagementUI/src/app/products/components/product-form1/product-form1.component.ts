...
export class ProductForm1Component implements OnInit {
  ...
  initForm(model?: ProductModel) {
    ...
    this.itemsInBox = new FormControl((model != null && !this.itemsInBox) ? model.itemsInBox : 0, Validators.compose([Validators.required, Validators.min(1)]));
    this.sellingUnitPrice = new FormControl((model != null && !this.sellingUnitPrice) ? model.sellingUnitPrice : 0, Validators.compose([Validators.required, Validators.min(1)]));
    this.sellingBoxPrice = new FormControl((model != null && !this.sellingBoxPrice) ? model.sellingBoxPrice : 0, Validators.compose([Validators.required, Validators.min(1)]));
