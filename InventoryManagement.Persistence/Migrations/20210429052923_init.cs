        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_State = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Address_ZipCode = table.Column<string>(type: "nvarchar(18)", maxLength: 18, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DividerSlots = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarehouseId = table.Column<long>(type: "bigint", nullable: false),
                    WarehouseBinId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Bins_WarehouseBinId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_WarehouseBinId",
                schema: "Identity",
                table: "Products",
