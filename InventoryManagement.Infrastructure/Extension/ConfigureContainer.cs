...
namespace InventoryManagement.Infrastructure.Extension
{
    public static class ConfigureContainer
    {
        ...
        public static void ConfigureStaticFilePath(this IApplicationBuilder app, IConfiguration configuration)
        {
            var WebRootPath = configuration["AppSettings:FileRooTPath"];
